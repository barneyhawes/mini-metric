...
# Water
set water_meter_background_id [.can create oval [rescale_x_skin 2140] [rescale_y_skin 1130] [rescale_x_skin 2580] [rescale_y_skin 1570] -fill $::color_status_bar -width 0 -state "hidden"]
...
# Temperature
set temperate_meter_background_id [.can create oval [rescale_x_skin -20] [rescale_y_skin 1130] [rescale_x_skin 420] [rescale_y_skin 1570] -fill $::color_status_bar -width 0 -state "hidden"]
