...
create_symbol_button2 $espresso_contexts 2260 60 240 20 [translate "exit"] $::symbol_power $::color_button_function { say [translate "sleep"] $::settings(sound_button_in); app_exit} 80 18
