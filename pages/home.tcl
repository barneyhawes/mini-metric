...
create_symbol_button2 $espresso_contexts 2260 60 240 20 [translate "sleep"] $::symbol_power $::color_button_function { say [translate "sleep"] $::settings(sound_button_in); start_sleep} 80 18
